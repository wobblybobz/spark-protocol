...
exports.DEVICE_EVENT_NAMES = undefined;
...
var SparkCore = function (_EventEmitter) {
  ...
  function SparkCore(socket, connectionKey) {
    var _this2 = this;
    ...
    _this._sendToken = 0;
    _this._tokens = {};
    _this.startupProtocol = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
    ...
    _this.handshake = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
      var handshake;
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _context3.delegateYield(regeneratorRuntime.mark(function _callee2() {
                var _ref3, coreId, cipherStream, decipherStream, handshakeBuffer, pendingBuffers, sessionKey;
    ...
    _this.onApiMessage = function () {
      var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(sender, message) {
    ...
    _this.sendMessage = function (messageName, params, data, requester) {
      ...
      if (!_this._cipherStream) {
        _logger2.default.error('Client - sendMessage before READY', { messageName: messageName, coreID: _this.getHexCoreID() });
        return -1;
      }
    ...
    _this.listenFor = function () {
      var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(name, uri, token) {
    ...
    _this._getVariable = function () {
      var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(name, type) {
    ...
    _this._setVariable = function () {
      var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(name, data) {
        var payload, token;
    ...
    _this._callFunction = function () {
      var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(name, args) {
        var _ret2;
    ...
    _this._raiseYourHand = function () {
      var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(showSignal) {
        var token;
    ...
    _this.flashCore = function (binary, sender) {
      ...
      try {
        _logger2.default.log('flash device started! - sending api event', { deviceID: _this.getHexCoreID() });
        ...
        _logger2.default.log('flash device finished! - sending api event', { deviceID: _this.getHexCoreID() });
        ...
        _logger2.default.log('flash device failed! - sending api event', { deviceID: _this.getHexCoreID(), error: error });
    ...
    _this._transformArguments = function () {
      var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(name, args) {
    ...
    _this._ensureWeHaveIntrospectionData = _asyncToGenerator(regeneratorRuntime.mark(function _callee13() {
