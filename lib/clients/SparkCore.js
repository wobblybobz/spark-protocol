  ...
  function SparkCore(socket) {
    ...
    _this.flashCore = function (binary, sender) {
      ...
      try {
        ...
        _logger2.default.log('flash core failed! - sending api event', { coreID: _this.getHexCoreID(), error: error });
        // TODO implement another way
    ...
    _this.onCoreSubscribe = function (message, isPublic) {
      ...
      global.publisher.subscribe(name, _this.onCoreEvent, deviceID);
    };
