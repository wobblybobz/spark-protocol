...
SparkCore.prototype = extend(ISparkCore.prototype, EventEmitter.prototype, {
    ...
    handshake: function handshake() {
        ...
        shaker.handshake(this, utilities.proxy(this.ready, this), utilities.proxy(this.disconnect, this));
    },
    ...
    _checkOwner: function _checkOwner(requester, onError, messageName) {
