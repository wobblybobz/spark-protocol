  ...
  function SparkCore(socket) {
    ...
    _this.onApiMessage = function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(sender, message) {
        var isBusy, result, _result, _result2, sendResult, _sendResult, showSignal, _result3, _result4;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                _context3.next = _context3.t0 === 'Describe' ? 7 : _context3.t0 === 'GetVar' ? 18 : _context3.t0 === 'SetVar' ? 24 : _context3.t0 === 'CallFn' ? 30 : _context3.t0 === 'UFlash' ? 45 : _context3.t0 === 'FlashKnown' ? 48 : _context3.t0 === 'RaiseHand' ? 51 : _context3.t0 === 'Ping' ? 58 : 62;
                break;
                    ...
                    while (1) {
                      switch (_context7.prev = _context7.next) {
                        ...
                        case 2:
                          ...
                          token = _this.sendMessage('FunctionCall', { name: name, args: buffer, _writeCoapUri: writeUrl }, null);
                          _context7.next = 8;
    ...
    _this._ensureWeHaveIntrospectionData = _asyncToGenerator(regeneratorRuntime.mark(function _callee11() {
      var message, data, functionState;
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 6:
              ...
              data = message.getPayload();
              functionState = JSON.parse(data.toString());
    ...
    _this._onCoreSentEvent = function () {
      var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(message, isPublic) {
        var eventData, lowername, coreId, claimCode, coreAttributes, token, systemMessage, eat_message, result;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 31:
                ...
                _logger2.default.error('_onCoreSentEvent: failed writing to socket - ' + _context12.t0);
