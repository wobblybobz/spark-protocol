...
var ChunkingStream = function (_Transform) {
  _inherits(ChunkingStream, _Transform);

  function ChunkingStream(options) {
    _classCallCheck(this, ChunkingStream);

    var _this = _possibleConstructorReturn(this, (ChunkingStream.__proto__ || Object.getPrototypeOf(ChunkingStream)).call(this, options));
