...
EventPublisher.prototype = {
    getEventKey: function getEventKey(name, userid, coreid) {
        var ret = userid;
        if (coreid) {
            ret += '_' + coreid;
        }
    ...
    getEventName: function getEventName(name, coreid) {
        var eventName = "";
        if (coreid) {
            eventName = coreid;
            if (name && name != "") {
    ...
    publish: function publish(isPublic, name, userid, data, ttl, published_at, coreid) {
    ...
    subscribe: function subscribe(name, userid, coreid, obj, objHandler) {
        ...
        if (!obj[key + "_handler"]) {
            ...
            if (objHandler) {
                ...
                handler = function (isPublic, name, userid, data, ttl, published_at, coreid) {
    ...
    unsubscribe: function unsubscribe(name, userid, coreid, obj) {
        var key = this.getEventKey(name, userid, coreid);
        if (key) {
