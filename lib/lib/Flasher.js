...
function Flasher(client) {
	...
	this.startFlashBuffer = function () {
		var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(buffer) {
	...
	this._beginUpdate = function () {
		var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(buffer) {
	...
	this._sendFile = _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
	...
	this._onAllChunksDone = _asyncToGenerator(regeneratorRuntime.mark(function _callee8() {
	...
	this._onChunkMissed = function (message) {
		if (_this._missedChunks.size > MAX_MISSED_CHUNKS) {
			var json = JSON.stringify(_this._getLogInfo());
			throw new Error('flasher - chunk missed - core over limit, killing! ' + json);
		}
