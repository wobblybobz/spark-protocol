...
var Flasher = function Flasher(client) {
			...
			while (1) {
				switch (_context4.prev = _context4.next) {
					case 0:
						...
						isFastOTA = _this._protocolVersion > 0;
	...
	this._resendChunks = function () {
		var allChunksRecieved = _this._missedChunks.size > 0;

		if (!allChunksRecieved) {
			var missedChunks = Array.from(_this._missedChunks.entries());
	...
	this.onAllChunksDone = _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
		var result;
