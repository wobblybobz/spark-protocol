...
var Handshake = function Handshake(client) {
  ...
  this._runHandshake = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
    var dataAwaitable, nonce, data, coreProvidedPem, publicKey, _ref3, cipherStream, decipherStream, sessionKey, handshakeBuffer;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            publicKey = _this._getCoreKey((0, _nullthrows2.default)(coreProvidedPem));
            _context2.next = 12;
          ...
          case 18:
            ...
            return _context2.abrupt('return', {
              coreId: _this._coreId,
              cipherStream: cipherStream,
              decipherStream: decipherStream,
              handshakeBuffer: handshakeBuffer,
              pendingBuffers: [].concat(_toConsumableArray(_this._pendingBuffers)),
  ...
  this._getCoreKey = function (coreProvidedPem) {
    ...
    try {
      if (!publicKey) {
        ...
        throw 'Failed finding key for core: ' + _this._coreId;
      }
    } catch (exception) {
