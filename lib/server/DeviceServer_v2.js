...
var DeviceServer = function () {
  function DeviceServer(deviceServerConfig, eventPublisher) {
    ...
    this._onDeviceDisconnect = function (device) {
      ...
      if (_this._devicesById.has(deviceID)) {
        ...
        _logger2.default.log('Session ended for device with ID: ' + deviceID);
      }
    };
                        ...
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            ...
                            device.on('disconnect', function () {
                              return _this2._onDeviceDisconnect(device);
                            });
                          ...
                          case 7:
                            _logger2.default.log('Connection from: ' + device.getRemoteIPAddress());
