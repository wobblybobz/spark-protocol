...
var DeviceServer = function () {
  ...
  _createClass(DeviceServer, [{
        ...
        process.nextTick(function () {
          try {
            ...
            core.on('ready', function () {
              ...
              var deviceAttributes = _extends({}, _this._deviceAttributeRepository.getById(deviceID), {
                deviceID: deviceID,
            ...
            core.on('disconnect', function (message) {
              ...
              _this._publishSpecialEvent('particle/status', 'offline', deviceID);
    ...
    value: function getAllCoreIDs() {
      return this._config.deviceAttributeRepository.getAll().map(function (core) {
        return core.coreID;
      });
    }
