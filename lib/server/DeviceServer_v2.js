...
var DeviceServer = function () {
  function DeviceServer(deviceServerConfig, eventPublisher) {
    ...
    this._onNewSocketConnection = function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(socket) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          ...
                          device.on('ready', _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
              ...
              case 4:
                ...
                _logger2.default.error('Device startup failed: ' + _context3.t1.message);
  ...
  _createClass(DeviceServer, [{
    ...
    value: function () {
      ...
      function publishSpecialEvent(_x7, _x8, _x9) {
